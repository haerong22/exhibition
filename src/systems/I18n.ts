...
const ko: Messages = {
  ...
  'btn.install.label': '앱으로 설치',
  'btn.install.title': '홈 화면에 앱으로 설치',
  'picker.btn.newTemplate': '새 템플릿 만들기',
  'picker.btn.newExhibition': '새 전시회 만들기',
  'picker.template.moodboardPlaceholder': '무드보드 ID (선택)',
  'picker.template.moodboardGo': '만들기',
  ...
  'data.backup': '백업 내보내기',
  'data.restore': '백업 복원',
  'data.confirmRestore': '{n}개 항목을 복원하면 기존 값이 덮어씌워집니다. 계속하시겠습니까?',
  'data.restoreInvalid': '백업 파일 형식이 올바르지 않습니다.',
  'data.restoreEmpty': '복원할 항목이 없습니다.',
  'data.previewTitle': '백업 복원 미리보기',
  'data.preview.file': '파일',
  'data.preview.exportedAt': '내보낸 시점',
  'data.preview.itemCount': '복원할 항목',
  'data.preview.warn': '기존에 저장된 같은 키의 값은 덮어씌워집니다.',
  'data.preview.cancel': '취소',
  'data.preview.confirm': '복원',
  'backup.hintTitle': '데이터 백업을 권장합니다',
  'backup.hintDesc': '이 브라우저에 {size}의 갤러리 데이터가 있습니다. 실수로 초기화되지 않도록 백업을 만들어두세요.',
  'backup.hintAction': '백업 만들기',
  ...
  'data.key.moodboardHistory': '최근 무드보드 ID 기록',
  ...
  'editor.mode.mapDesc': '바닥·벽·문·소품 등 구조 배치',
  'editor.mode.exhibitionDesc': '작품·시작점만 배치 가능',
  'editor.mode.toggle': '모드 전환 (M)',
  ...
  'editor.moodboard.cached': '최근 방문 · 작품 {n}개',
  'editor.moodboard.removeRecent': '히스토리에서 제거',
  ...
  'editor.data.dirtyWarn': '저장하지 않은 변경 사항이 있습니다. 데이터 관리에서 에디터 드래프트를 삭제하면 작업이 사라질 수 있습니다.',
  'editor.data.dirtyProceed': '계속',
  'editor.data.dirtyCancel': '취소',
  'editor.save.idle': '변경 사항 없음',
  'editor.save.dirty': '저장 대기 중',
  'editor.save.saved': '{rel} 자동 저장됨',
  'editor.save.clickToSave': '클릭하여 지금 저장',
...
const en: Messages = {
  ...
  'btn.install.label': 'Install app',
  'btn.install.title': 'Install to your home screen',
  'picker.btn.newTemplate': 'New template',
  'picker.btn.newExhibition': 'New exhibition',
  'picker.template.moodboardPlaceholder': 'Moodboard ID (optional)',
  'picker.template.moodboardGo': 'Create',
  ...
  'data.backup': 'Export backup',
  'data.restore': 'Restore backup',
  'data.confirmRestore': 'Restore {n} item(s)? This will overwrite existing values.',
  'data.restoreInvalid': 'Invalid backup file.',
  'data.restoreEmpty': 'No items to restore.',
  'data.previewTitle': 'Backup restore preview',
  'data.preview.file': 'File',
  'data.preview.exportedAt': 'Exported',
  'data.preview.itemCount': 'Items to restore',
  'data.preview.warn': 'Existing values for the same keys will be overwritten.',
  'data.preview.cancel': 'Cancel',
  'data.preview.confirm': 'Restore',
  'backup.hintTitle': 'Backup recommended',
  'backup.hintDesc': 'This browser holds {size} of gallery data. Create a backup to avoid accidental loss.',
  'backup.hintAction': 'Create backup',
  ...
  'data.key.moodboardHistory': 'Recent moodboard IDs',
  ...
  'editor.mode.mapDesc': 'Place floor / walls / doors / props',
  'editor.mode.exhibitionDesc': 'Only artworks and spawn points',
  'editor.mode.toggle': 'Toggle mode (M)',
  ...
  'editor.moodboard.cached': 'Recent · {n} artworks',
  'editor.moodboard.removeRecent': 'Remove from history',
  ...
  'editor.data.dirtyWarn': 'You have unsaved changes. Deleting the editor draft in Data Manage may discard your work.',
  'editor.data.dirtyProceed': 'Proceed',
  'editor.data.dirtyCancel': 'Cancel',
  'editor.save.idle': 'No changes',
  'editor.save.dirty': 'Unsaved changes',
  'editor.save.saved': 'Auto-saved {rel}',
  'editor.save.clickToSave': 'Click to save now',
